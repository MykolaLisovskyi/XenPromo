...
<head>
  ...
  <link rel="stylesheet" href="css/frameKeysSlider.css">
  <link rel="stylesheet" href="css/frameKeys.css">
...
<body>
  ...
  <header>
    ...
    <content>
      ...
      <section class="drawer-list">
        <ul>
          ...
          <li><a href="frameKeys.php" style="font-weight: bold; pointer-events: none; cursor: default;">Кейсы</a></li>
    ...
    <nav>
      <a href="index.php" style="">SMM</a>
      <a href="frameAttraction.php">Привлечение пользователей</a>
      <a href="" style="font-weight:bold;pointer-events: none; cursor: default;">Кейсы</a>
      <a href="frameWhy.php">Почему мы</a>
    </nav>
  </header>
  <div class="content">
    <p class="name">Кейсы</p>
