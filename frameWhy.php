...
<head>
  ...
  <link rel="stylesheet" href="css/frameAttraction.css">
...
<body>
  <div class="col-md-4 col-xs-12 b-popup" id="popup1" style="z-index:66;">
    <div й class="pricepop lux b-popup-content">
      ...
      <form class="popupform" action="send/telegram.php" method="post">
  ...
  <header>
    ...
    <content>
      ...
      <section class="drawer-list">
        <ul>
          ...
          <li><a href="frameWhy.php" style="font-weight: bold; pointer-events: none; cursor: default;">Почему мы</a></li>
          <li><a href="frameAttraction.php">Привлечение пользователей</a></li>
    ...
    <nav>
      <a href="index.php">SMM</a>
      <a href="frameAttraction.php">Привлечение пользователей</a>
      <a href="frameKeys.php">Кейсы</a>
      <a href="" style="font-weight:bold;pointer-events: none; cursor: default;">Почему мы</a>
    </nav>
  </header>
  <div class="content">
    <p class="name">Почему мы</p>
      ...
      <div class="left_content">
        <div class="">
          <div class="left_block">
            <div class="block_img">
              <img src="image/line_attraction.png" alt="">
            </div>
            <div class="inform">
              <p>Преимущество 1</p>
              <p>Сюда хорошо бы какой-то текст все же написать, кратко о том, чтобы люди сразу нажали</p>
            </div>
          </div>
          <div class="left_block">
            <div class="block_img">
    ...
    <div class="button">
      <a href="javascript:PopUpShow();">Оставить заявку</a>
    </div>
